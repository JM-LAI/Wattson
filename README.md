...
All modes powered by Gemma 4 31B on Lightning AI (free tier) by default. Pick from a curated capable set — Gemma 4 31B, GPT-OSS 120B, DeepSeek V4 Pro, Nemotron Super 120B, Nemotron Ultra 550B, MiniMax M2.5 — right from the menu bar. If a model is down, Wattson automatically falls back to the next available model and lets you know.
